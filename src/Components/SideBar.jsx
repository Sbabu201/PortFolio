        ...
        <React.Fragment>
            ...
            >
                <ul className="flex flex-col items-center justify-center  gap-2  font-bold font-times md:hidden">
                    ...
                    <li onClick={() => { navigate("/#home"); toggleDrawer() }} className={` w-[90%] mx-auto  py-3  bg-gradient-to-r hover:from-purple-200 hover:to-purple-600  px-6 rounded-md hover:animate-pulse hover:text-white transition-all duration-300 ease-in-out ${data === "home" && window.location.pathname === "/" ? "from-purple-200 to-purple-600 text-white " : ""}`}>
                        <p >Home</p>
                    </li>
                    <li onClick={() => { navigate("/#aboutme"); toggleDrawer() }} className={`  w-[90%] mx-auto   py-3  bg-gradient-to-r hover:from-purple-200 hover:to-purple-600  px-6 rounded-md hover:animate-pulse hover:text-white transition-all duration-300 ease-in-out ${data === "aboutme" && window.location.pathname === "/" ? "from-purple-200 to-purple-600 text-white " : ""}`}>
                        <p >About Me</p>
                    </li>
                    <li onClick={() => { navigate("/#skills"); toggleDrawer() }} className={`  w-[90%] mx-auto   py-3  bg-gradient-to-r hover:from-purple-200 hover:to-purple-600  px-6 rounded-md hover:animate-pulse hover:text-white transition-all duration-300 ease-in-out ${data === "skills" && window.location.pathname === "/" ? "from-purple-200 to-purple-600 text-white " : ""}`}>
                        <p >Skills</p>
                    </li>
                    ...
                    <li onClick={() => { navigate("/#contact"); toggleDrawer() }} className={`  w-[90%] mx-auto   py-3  bg-gradient-to-r hover:from-purple-200 hover:to-purple-600  px-6 rounded-md hover:animate-pulse hover:text-white transition-all duration-300 ease-in-out ${data === "contact" && window.location.pathname === "/" ? "from-purple-200 to-purple-600 text-white " : ""}`}>
                        <p >Contact Us</p>
                    </li>
